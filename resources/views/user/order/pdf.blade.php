...
<html>
<head>
  <title>Hoá đơn @if($order)- {{$order->cart_id}} @endif</title>
...
<style type="text/css">
    ...
    <table class="table table-bordered table-stripe">
      ...
      @endif --}}
        <tr>
          ...
          <th><span>{{number_format($order->delivery_charge)}}₫</span></th>
        </tr>
        <tr>
          <th scope="col" class="empty"></th>
  ...
  <div class="thanks mt-3">
    <h4>Cảm mơn bạn đã mua đơn hàng tại Supcua Shop !!</h4>
  </div>
