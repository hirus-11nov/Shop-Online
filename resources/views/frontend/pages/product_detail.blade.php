...
@endsection
@section('title','Supcua Shop || CHI TIẾT SẢN PHẨM')
					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="">Chi chiết sản phẩm</a></li>
							</ul>
						</div>
					</div>
				</div>
								...
								<div class="row">
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<!-- Color -->
											{{-- <div class="color">
												<h4>Lựa chọn <span>Màu sắc</span></h4>
												<ul>
															...
															<div class="col-12">
																...
																<div class="ratting-main">
																	<div class="avg-ratting">
																		...
																		@endphp --}}
																		<h4>{{ceil($product_detail->getReview->avg('rate'))}} <span>(Tổng điểm)</span></h4>
