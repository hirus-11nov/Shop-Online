<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
      ...
      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item" href="{{route('banner.create')}}">Thêm mới</a>
        </div>
      </div>
    </li>
    <!-- Divider -->
    ...
    <li class="nav-item">
        ...
        <div id="brandCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{route('brand.create')}}">Thêm mới</a>
          </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="shippingCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Tuỳ chọn:</h6>
            <a class="collapse-item" href="{{route('shipping.index')}}">Giao hàng</a>
            <a class="collapse-item" href="{{route('shipping.create')}}">Thêm mới</a>
          </div>
        </div>
    </li>
