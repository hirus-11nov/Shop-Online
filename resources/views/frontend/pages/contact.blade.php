						...
						<div class="col-lg-8 col-12">
							<div class="form-main">
								<div class="title">
									...
									@endphp
									<h4>Liên lạc</h4>
									<h3>Viết tin nhắn cho chúng tôi @auth @else<span style="font-size:12px;" class="text-danger">[Trước tiên bạn cần phải đăng nhập!]</span>@endauth</h3>
								</div>
	...
	<div class="modal fade" id="error" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
			...
			<div class="modal-body">
				<p class="text-warning">Có lỗi xảy ra.</p>
			</div>
		  </div>
		</div>
	</div>
