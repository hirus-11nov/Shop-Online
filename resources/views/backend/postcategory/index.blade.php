...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('post-category.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Thêm danh mục</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        ...
        @else
          <h6 class="text-center">Không tìm thấy danh mục bài viết!!! Vui lòng tạo danh mục bài viết</h6>
        @endif
      </div>
    </div>
</div>
