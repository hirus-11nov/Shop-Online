<div id="messages">
    ...
    <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
        ...
        <div id="message-items">
            ...
            <div>
                <div class="text-truncate">Hihi</div>
                <div class="small text-gray-500">Hiếu chó· 2w</div>
            </div>
            </a> --}}
        </div>
        <a class="dropdown-item text-center small text-gray-500" href="{{route('message.index')}}">Đọc</a>
    </div>
</div>
